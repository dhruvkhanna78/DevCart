    ...
    return product && (
        <div className="max-w-6xl w-full px-6 mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            <img src={i < 4 ? assets.star_icon : assets.star_dull_icon} alt="Filled star" className='md:w-4 w-3.5' />
                        ))}
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-6 lg:gap-13'>
                    {
